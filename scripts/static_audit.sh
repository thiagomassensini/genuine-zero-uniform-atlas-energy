...
# depend on a floating-point witness or on the campaign archive.
...
python3 -m json.tool audit/release-manifest-0.17.0.json >/dev/null
...
test -s audit/RELEASE_MANIFEST_0.17.0.md
